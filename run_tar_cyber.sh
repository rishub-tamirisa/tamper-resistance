...
--warmup_steps 32 \
--lr 2e-05 \
--adversary_lr_samples 2e-5,4e-5 \
--batch_size 8 \
--gradient_accumulation_steps 1 \
--adversary_dist_types forget_train:0.5,retain_forget_switch:0.5 \
...
--base_model_name Llama-3-8B-Instruct-Random-Mapped-Cyber \
--subject cyber \
--base llama3 \
--new_model_name Llama-3-8B-Instruct-TAR-Cyber